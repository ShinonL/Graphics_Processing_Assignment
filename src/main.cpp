...
void mouseCallback(GLFWwindow* window, double xpos, double ypos) {
    ...
    double offsetX = (xpos - previousX) * 0.15;
    double offsetY = (previousY - ypos) * 0.15;
...
void processMovement() {
    ...
    if (pressedKeys[GLFW_KEY_O]) {
        ...
        //set light type
        isPointLightLoc = glGetUniformLocation(myBasicShader.shaderProgram, "isPointLight");
        // send light type to shader
...
void initModels() {
    scene.LoadModel("models/scene/scene_final.obj");
...
void renderTeapot(gps::Shader shader) {
    ...
    if (animation) {
        ...
        modelCar = glm::translate(modelCar, glm::vec3(1, 0, 0));
    ...
    glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(modelCar));
